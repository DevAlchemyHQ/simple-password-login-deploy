  ...
  return (
    ...
    >
      <div className="lg:col-span-10 grid grid-cols-1 lg:grid-cols-12 gap-4 h-full overflow-hidden">
        ...
        <div className={`h-full overflow-hidden transition-[opacity,transform] duration-300 ${isExpanded ? 'hidden lg:col-span-0' : 'block lg:col-span-6'
          }`}>
          <ImageGrid />
        </div>

        {/* Selected Images Panel - Expand to full width when expanded */}
        <div className={`h-full overflow-hidden transition-[opacity,transform] duration-300 ${isExpanded ? 'lg:col-span-12' : 'lg:col-span-6'
          }`}>
          <SelectedImagesPanel
